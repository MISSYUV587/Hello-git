...
def get_dv(start = 20170101,end = 20180101):
    ...
    #define
    factor_list  = ['ACCAP','alpha007','BIASA','CoppockCurve_J','CORRVW','EMAA22','SRMI_C','VolatilityC','WVOL5']
...
import ACCAP,alpha007,BIASA,CoppockCurve_J,CORRVW,EMAA22,SRMI_C,VolatilityC,WVOL5
for f in ['ACCAP','alpha007','BIASA','CoppockCurve_J','CORRVW','EMAA22','SRMI_C','VolatilityC','WVOL5']:
